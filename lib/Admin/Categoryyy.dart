...
import 'package:flutter/material.dart';
 ...
 class Categoryyy extends StatefulWidget {
  const Categoryyy({super.key});

  @override
  State<Categoryyy> createState() => _CategoryyyState();
}

class _CategoryyyState extends State<Categoryyy> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Category'),backgroundColor: Color.fromARGB(255, 53, 87, 33),
        leading: IconButton(
          icon: Icon(
            Icons.arrow_back,
            color: Colors.white,
